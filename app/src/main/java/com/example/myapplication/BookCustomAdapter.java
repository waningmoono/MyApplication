...
public class BookCustomAdapter extends BaseAdapter{
    private ArrayList<BookCustomDTO> listCustom = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.book_item, null, false);
        ...
        BookCustomDTO dto = listCustom.get(position);
